...
Neon Player is written in `Python 3.12`. At its core, Neon Player is built on top of the [Neon Recording API](../../recording-api/) and features a user interface based on [PyQt](https://doc.qt.io/qtforpython-6/).
