...
::: tip
If presenting the markers on a digital display (tablet, monitor or through PsychoPy), you may need to tweak the display brightness and exposure settings to improve marker detection. Typically, dimming the display brightness helps avoid overexposure and improves marker visibility.
:::
