...
![Devices Linking Devices](./link_device.webp)

![Devices Storage](./device_storage.webp)
...
creating [workspaces](../workspaces/) and inviting collaborators to them.

Invited users can view, edit, enrich, and download recordings according to their assigned roles. When they upload recordings 
from a linked device into one of these workspaces, they also benefit from the plan. This setup allows your team to share the 
features of your Unlimited Analysis Plan (and privacy features, where applicable) without requiring additional plans, 
...
Upon inviting other users to your workspace, they can keep using their credentials to log into the [Companion App](../../data-collection/ecosystem-overview/#neon-companion-app), they simply need to select the appropiate workspace before making the recording.
