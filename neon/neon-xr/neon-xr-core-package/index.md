...
::: tip
You can stream & receive data in your Unity program without starting a recording. Note that the real-time reception rate will be determined by Unity's update rate.
:::
