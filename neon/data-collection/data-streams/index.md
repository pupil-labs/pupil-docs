...
The fixation detector runs on the device in real-time (if enabled, and if the data rate in the App is set to 200 Hz). Fixations and saccades are also computed during post-processing in Pupil Cloud.
:::
