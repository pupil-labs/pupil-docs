...
| **eyelid angle top left**<br />**eyelid angle bottom left**<br />**eyelid angle top right**<br />**eyelid angle bottom right**                                                                                                                                                                             | Angles quantifying the vertical opening of the left and right eyes' upper and lower eyelids relative to the optical axes horizontal plane in radians.                                                                                                            |
| **eyelid aperture left [mm]**<br />**eyelid aperture right [mm]**                                                                                                                                                                                                                                          | Maximum vertical distance between the left and right eyes' upper and lower eyelids, measured in millimeters.                                                                                                                                                     |
