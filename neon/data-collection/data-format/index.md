...
| **eyelid_angle_top_left** | Angle quantifying the vertical opening of the left eyes’ upper eyelid relative to the scene camera’s horizontal plane.
| **eyelid_angle_bottom_left** | Angle quantifying the vertical opening of the left eyes’ lower eyelid relative to the scene camera’s horizontal plane.
| **eyelid_angle_top_right** | Angle quantifying the vertical opening of the right eyes’ upper eyelid relative to the scene camera’s horizontal plane.
| **eyelid_angle_bottom_right** |  Angle quantifying the vertical opening of the right eyes’ lower eyelid relative to the scene camera’s horizontal plane.
| **eyelid_aperture_mm_left** | Maximum vertical distance between the left eye's upper and lower eyelids, measured in millimeters.
| **eyelid_aperture_mm_right** | Maximum vertical distance between the right eye's upper and lower eyelids, measured in millimeters.|
