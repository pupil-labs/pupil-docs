...
:::danger
Our previous real-time API called NDSI is now deprecated! We recommend using the new real-time API client introduced [here](/invisible/real-time-api/introduction/).
:::
