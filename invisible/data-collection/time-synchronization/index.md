...
This can be done using the `TimeOffsetEstimator` of the [real-time API](/real-time-api/). Using the following code, you can estimate the offset between the Pupil Invisible clock and the clock of the host executing the code.
::: tip
