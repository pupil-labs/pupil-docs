...
| **roll** | Drift-free estimation of the roll (head tilt from side to side) in degrees. Added in version 2 of this enrichment.    |
| **pitch** | Drift-free estimation of the pitch (head tilt from front to back) in degrees.  Added in version 2 of this enrichment.    |
